...
<body class="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white min-h-screen">
    <div class="container mx-auto px-6 py-20">
        <div class="text-center">
            <h1 class="text-6xl font-bold mb-6 bg-gradient-to-r from-white to-indigo-200 bg-clip-text text-transparent">
                Indigo3 Inventory Management
            </h1>
...
<?php /**PATH /Users/lib/Dropbox/wwwdevelop/sites/i3v2-bots/resources/views/indigo3-landing.blade.php ENDPATH**/ ?>